import { BuscarRelatoDia, ListarRelatosDia } from '@/api/relato-dia/relato-dia.service';
import { Heading } from '@/components/others/typography'
import { Button } from "@/components/ui/button";
import { Edit, Delete } from '@hugeicons/core-free-icons';
...
function formatarDataDoJava(dataString: string): string {
  ...
  return(
        ...
        <header className="flex justify-between items-center">
          ...
          <Heading as="h2" variant="h2" className="border-none">
          ...
          <div className="flex gap-4 items-center">
            ...
            <Button variant="outline" className=""  onClick={(event) => { event.stopPropagation(); window.location.href = `/relatoDia/editar/${relato.dataRegistro}`; }}>
      ...
      <div className="prose dark:prose-invert">
        <Markdown>{data?.conteudoHtml}</Markdown>
    </div>
